...
export default function HeroPrograms() {
  return (
    <section className="flex min-h-[100vh] flex-col items-center justify-center text-center">
      ...
      <div className="flex w-full flex-wrap justify-center-safe gap-4">
        {cards.map((card, idx) => (
          <Card
            key={idx}
            className={`${card.className} h-72 w-full p-3 text-left text-white md:max-w-md`}
          >
